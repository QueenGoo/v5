#!/bin/bash
REPO="https://raw.githubusercontent.com/QueenGoo/v5/main/"
clear
run_eula() {
if [ "${EUID}" -ne 0 ]; then
...
run_ei() {
  ...
  # Link izin IP VPS
  url_izin='https://raw.githubusercontent.com/QueenGoo/v5/main/izin.txt'
...
<b><font color='#B8860B'>⇱ QUEEN STORE ⇲</font><br> 
...
<b><font color='#66CDAA'>TELEGRAM:</font> <font color='#800000'></font><br>
<b><font color='#66CDAA'>WHATSAPP :</font> <font color='#800000'></font><br>
<b><font color='#66CDAA'>GROUP:</font> <font color='#800000'>https://chat.whatsapp.com/KXFECkZcX70BssFQZ3kQXA</font><br>
<b><font color='#66CDAA'>TESTIMONI:</font> <font color='#800000'></font><br>
END
